      ...
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        ...
        <div class="swiper-container swiper-zhutu">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="{{ $list->goods_img }}" /></div>
          </div>
        ...
        <div class="wy-media-box-nomg weui-media-box_text">
          ...
          <div class="wy-pro-pri mg-tb-5" id="goods_price">
            <em class="num font-20">{{ $list->goods_price }}</em>
          </div>
...
<div class="weui-tabbar wy-foot-menu">
  ...
  <a href="javascript:;" class="weui-tabbar__item yellow-color open-popup" data-target="#join_cart">
    <p class="promotion-foot-menu-label adminCart" goods_id="{{ $list->goods_id }}">加入购物车</p>
  </a>
      ...
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="{{ url('/cartinfo') }}" class="weui-btn weui-btn_primary">去购物车结算</a>
...
// 购物车
  $(document).on('click','.adminCart',function(){
    var _this=$(this);
    ...
    $.ajax({
        headers: {
         ...
         url:'/cartadd',
         type:'POST',
         data:{goods_id:goods_id,add_price:goods_price,buy_number:buy_number},
         dataType:'json',
         async:true,
